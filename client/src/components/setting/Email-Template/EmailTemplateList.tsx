...
interface EmailTemplateListProps {
  ...
  >;
  startEditingTemplate: (template: IEmailTemplate) => void;
            ...
            <div className="space-y-4">
              {emailTemplates &&
                emailTemplates.map((template) => (
                  <Card key={template._id} className="border">
                        ...
                        <div className="flex gap-2">
                          <Popover>
                            ...
                            <PopoverContent className="w-96 p-0" side="left">
                              ...
                              <div className="p-3">
                                <iframe
                                  srcDoc={sanitizeHtml(template.body)}
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              ...
                              <DropdownMenuItem
                                onClick={() =>
                                  deleteEmailTemplate(template._id)
                                }
